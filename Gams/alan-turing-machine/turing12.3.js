	...
	var T = function (a) {
		...
		Rb = function () {
			...
			if ((Y = document.getElementById("hplogo")) && !google.doodle.ab) google.doodle.ab = e, window.google && (window.google.psy && window.google.psy.q && window.google.msg) && window.google.msg.listen(22, function () {
				Sb();
				return e
			}), a = ha("turing12-hp-sprite.png"), S.restore(), va(), w = i, ua(), N = i, M = 2, L = 8, Na("y"), m = new P, sb = i, tb = 0, vb.create(Y), X.create(google.doodle.alt || " ", google.doodle.url || "http://www.google.com/search?q=Alan+Turing"), b = U[S.i].A, V.create(0 == b ? 6 : b), k = new Q, k.create(), m.create(), W.create(), H.create(), wb(a) ? Ab() : a.onload = Ab
		},
		Sb = function () {
